...
First_ref = SDY.ReferenceContainer(
    name="First_ref",
    oid="c73fde81-226b-4e30-8e3a-3b4ca01391cc",
    origin=(-129.0, 86.0),
    scale=(1.0, 1.0),
    angle=0.0,
    clockwise=False,
    file="RefObject.ogfx",
    inputs=[
        ("Circle_X", SDY.PredefType(SDY.SimpleType.REAL)),
        ("Arc_Angle", SDY.PredefType(SDY.SimpleType.REAL)),
    ],
)
group_References.children.append(First_ref)
hook = SDY.Hook(name="hook", oid="8a788f82-3194-43ea-8570-4276ae11dce0", index=-1)
group_References.children.append(hook)
Operator1 = SDY.Behavior(
    name="Operator1",
    oid="666f164d-59f7-4eb3-9a9c-8fd8c7133b4f",
    file="TestBehaviour.etp",
    function="MainOp",
    inputs=[
        ("booleanInput", SDY.PredefType(SDY.SimpleType.BOOL)),
        ("realInput", SDY.PredefType(SDY.SimpleType.FLOAT64)),
        ("charArrayInput", SDY.ArrayType(SDY.PredefType(SDY.SimpleType.CHAR), SDY.LiteralExpr("12"))),
        ("intInput", SDY.PredefType(SDY.SimpleType.INT32)),
        ("intArrayInput", SDY.ArrayType(SDY.PredefType(SDY.SimpleType.INT32), SDY.LiteralExpr("12^5"))),
    ],
    outputs=[
        ("boolOutput", SDY.PredefType(SDY.SimpleType.BOOL)),
        ("intOuput", SDY.PredefType(SDY.SimpleType.INT32)),
        ("realArrayOutput", SDY.ArrayType(SDY.PredefType(SDY.SimpleType.FLOAT64), SDY.LiteralExpr("5"))),
    ],
)
Operator1.function.is_node = SDY.BooleanProp(True)
group_References.children.append(Operator1)
First_np = SDY.NplicatorContainer(
    name="First_np",
    oid="dcd5a6d1-333e-4383-9c2d-de04e25da6a8",
    nb_instances=2,
    file="RefObject.ogfx",
    origin=([67.0, 109.0], [-45.0, 3.0]),
    angle=[0.0],
    clockwise=False,
    scale=([1.0], [1.0]),
    inputs=[
        (
            "Circle_X",
            SDY.ArrayType(SDY.PredefType(SDY.SimpleType.REAL), SDY.LiteralExpr("2")),
        ),
        (
            "Arc_Angle",
            SDY.ArrayType(SDY.PredefType(SDY.SimpleType.REAL), SDY.LiteralExpr("2")),
...
group_References.children.append(First_np)
undefined = SDY.Imported(
    name="undefined",
    oid="73a0ef14-b72d-48dc-a65d-1a730975c7f1",
    function="MyFunc",
    inputs=[
        ("intInput", SDY.PredefType(SDY.SimpleType.INT)),
    ],
    outputs=[("intOutput", SDY.PredefType(SDY.SimpleType.INT))],
)
group_References.children.append(undefined)
assignment1 = SDY.Assignment(
    name="assignment1",
    oid="61208e3a-0b63-41ad-86c7-c7e117a5b5fc",
    input=SDY.LiteralExpr("0.0"),
    output=SDY.IdentifierExpr("LAYER1_Assignment_Output"),
)
group_References.children.append(assignment1)
assignment2 = SDY.Assignment(
    name="assignment2",
    oid="1535c982-6f83-4bef-a03e-daccbd88a360",
    input=SDY.LiteralExpr("0.0"),
    output=SDY.IdentifierExpr("LAYER1_Assignment_Output"),
)
...
output_path = "./TestDisplayAPI/OutputModels/SDY_PythonAPI_TC_N_051.sgfx"
