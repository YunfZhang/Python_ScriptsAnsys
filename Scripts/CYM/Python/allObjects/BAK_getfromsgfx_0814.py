...
for objects in object_nodes:
    top_object_oid = objects.get("oid")
    top_object_name = objects.tag
    obj_nodes = objects.findall("./")
    for obj_node in obj_nodes:
        if obj_node.tag == "properties":
            obj_name = obj_node.get("name")
            #added content to python script
            object_str += f"{obj_name} = SDY.{top_object_name.capitalize()}( "
            object_str += f"name = '{obj_name}', oid = '{top_object_oid}', "
